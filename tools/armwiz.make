...
# TODO Make source and object list case insensatitive
# TODO Add other target compiler flags to armwiz.config
...
function echoMakefile () {
	...
	echo "###########################"
	echo ""
	echo "# OpenOCD board configuration file"
	...
	echo "OPENOCD=\${OPENOCD_PATH}openocd"
	echo ""
	...
	echo ""
	echo "# Find libraries"
	#TODO Understand the next two lines and write the appropriate code
	echo "INCLUDES_LIBS="
	echo "LINK_LIBS="
	echo ""
